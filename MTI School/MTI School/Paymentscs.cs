...
{
    public partial class Paymentscs : Form
    {
        ...
        public Paymentscs()
        {
            ...
            adapter = new SqlDataAdapter("select * from mtiSchool. Payments", conn);
            adapter.Fill(dt);
            dataGridView1.DataSource = dt;
            this.Load += Paymentscs_Load;
        }

        private void Paymentscs_Load(object sender, EventArgs e)
        {
